...
public class BattleSystem : MonoBehaviour
{
    ...
    [SerializeField] BattleLevelHandler battleLevelHandler;
    ...
    {
        CameraManager.Instance.SetAttackZoomOnCamera(battleSlotManager.GetPlayerUnit());
        ...
        {
            battleLevelHandler.EnableExpCanvas();
            yield return battleLevelHandler.DisplayExperienceGained();
            yield return battleLevelHandler.CheckForLevelUp();
            battleLevelHandler.DisableExpComponents();

            yield return WaitUserInputBattleEnd(); //SHOULD BE AUTOMATIC LATER
    ...
    {
        battleSlotManager.GetPlayerUnit().UnitAnimator.DeathAnimation();
